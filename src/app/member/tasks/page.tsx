...
import { MemberTasksList } from "./member-tasks-list";
      ...
      <Tabs defaultValue="available" className="space-y-4">
        ...
        <TabsContent value="available">
          <Card>
            ...
            <CardContent>
              <MemberTasksList tasks={availableTasks} userId={user.id} approvedCounts={
        ...
        <TabsContent value="pending">
          <Card>
            ...
            <CardContent>
              <MemberTasksList completions={pendingCompletions} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="approved">
          <Card>
            ...
            <CardContent>
              <MemberTasksList completions={approvedCompletions} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="rejected">
          <Card>
            ...
            <CardContent>
              <MemberTasksList completions={rejectedCompletions} />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
