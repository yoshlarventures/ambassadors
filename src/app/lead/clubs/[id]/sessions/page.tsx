...
import { LeadSessionsList } from "./sessions-list";
...
export default async function LeadClubSessionsPage({
  params,
}: {
    ...
    <Tabs defaultValue="past" className="space-y-4">
      ...
      <TabsContent value="past">
        <Card>
          ...
          <CardContent>
            <LeadSessionsList sessions={pastConfirmed} clubId={id} showViewDetails />
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="upcoming">
        <Card>
          ...
          <CardContent>
            <LeadSessionsList sessions={upcomingSessions} clubId={id} />
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="needs-confirmation">
        <Card>
          ...
          <CardContent>
            <LeadSessionsList sessions={needsConfirmation} clubId={id} />
          </CardContent>
        </Card>
      </TabsContent>
    </Tabs>
