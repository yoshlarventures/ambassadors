...
export function TaskCompletionsList({ completions }: TaskCompletionsListProps) {
  ...
  if (completions.length === 0) {
    return <p className="text-muted-foreground text-center py-8">No pending submissions</p>;
  }
